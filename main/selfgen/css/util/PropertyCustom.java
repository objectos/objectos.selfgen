/*
 * Copyright 2024 Objectos Software LTDA.
 *
...
public final class PropertyCustom extends PropertyClass {

  private final List<Constant> constants = new ArrayList<>();

  private final String propertyName;

  public PropertyCustom(String simpleName, String propertyName) {
    super(simpleName);
