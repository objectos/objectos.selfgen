...
public class BaseApiStepTest {
  ...
  public void execute() {
    ...
    BaseApiStep template;
    template = new BaseApiStep(spec);
...
public sealed abstract class BaseApi extends Recorder permits BaseAttributes {
